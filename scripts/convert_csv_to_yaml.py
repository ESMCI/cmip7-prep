...
MODEL_CONFIGS = {
    ...
    "cesm": {
        ...
        "column_map": {
            "Modelling Realm - Primary": "table",
            "Title": "long_name",
            "CF Standard Name (from Physical Parameter)": "standard_name",
            "Units (from Physical Parameter)": "units",
            "Dimensions": "dims",
            "CESM Variable Name": "_source_expr",
            # "Formula" overrides _source_expr when present (round-trip format).
            # "CMIP7 Frequency", "Alias" are merged into sources in post-processing.
            "Formula": "_formula",
            "CMIP7 Frequency": "_freq",
            "Alias": "_alias",
